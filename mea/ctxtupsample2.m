function[ctxt,badidx]=ctxtupsample2(context)
% ctxt=CTXTUPSAMPLE2(context) returns realigned upsampled contexts,
% which must have been loaded by loadspks or equiv.
...
% 3. By writing [ctxt,badidx]=CTXTUPSAMPLE2(...), the indices of non-alignable
