function [centre radius] = circlefrom3(pt1, pt2, pt3)
% CIRCLEFROM3 - Calculate circle from 3 points on circumference
%    [xy0 R] = CIRCLEFROM3(xy1, xy2, xy3) calculates the center XY0 and 
%    radius R of a circle through three points XY1, XY2, and XY3.
%
%    By Peter Bone on MatlabCentral.
%    https://www.mathworks.com/matlabcentral/newsreader/view_thread/165185.
...
if (ax_is_0)
    [centre radius] = circlefrom3(pt1, pt3, pt2);
    return
end
if (bx_is_0)
    [centre radius] = circlefrom3(pt2, pt1, pt3);
    return
end
...
% centre of segments a and b intersect.
